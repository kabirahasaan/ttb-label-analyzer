...
COLA-2024-002,Reserve Cabernet,labels/cabernet.jpg`;
  ...
  return (
    <div className="container mx-auto max-w-6xl px-4 py-8">
      {/* Header */}
      <div className="mb-8">
        <h1 className="mb-2 text-3xl font-bold text-gray-900">Batch Label Validation</h1>
      ...
      <Card className={`mb-6 transition-all ${currentStep >= 1 ? 'ring-2 ring-blue-500' : ''}`}>
        <CardHeader>
                ...
                <div className="space-y-4">
                  <div className="rounded-lg bg-blue-50 p-4 border border-blue-200">
                    <p className="text-sm text-blue-900 font-medium">
                      Select <span className="font-bold">{selectedImages.length}</span> application
                      {selectedImages.length !== 1 ? 's' : ''} to match your {selectedImages.length}{' '}
                      label{selectedImages.length !== 1 ? 's' : ''}
                    </p>
      ...
      <Card
        ref={validationRef}
        className={`mb-6 transition-all ${
          isStep2Complete || isProcessing || isStep3Complete ? 'ring-2 ring-blue-500' : 'opacity-60'
        }`}
      >
        <CardHeader
          ...
          <CardContent className="space-y-6">
            ...
            <div className="rounded-lg border-l-4 border-slate-400 bg-slate-50 p-4">
              <p className="text-sm leading-relaxed text-slate-700">
                ...
                {results.warnings !== 1 ? 's' : ''}, and {results.nonCompliant} non-compliant label
                                ...
                                {result.discrepancies.map((discrepancy, idx) => (
                                  ...
                                  >
                                    ...
                                    <div className="grid gap-3 sm:grid-cols-2">
                                      <div className="rounded-md border border-green-300 bg-green-50 p-3">
                                        ...
                                        <p className="break-words text-sm font-medium text-green-900">
                                          {discrepancy.expected || '(Not specified in application)'}
                                        </p>
                                      </div>
                                    ...
                                    <div className="mt-3 rounded-md bg-white p-2 text-xs text-slate-600">
                                      <strong>Action needed:</strong> Update your label to match the
                                      approved application value
                                    </div>
                                  </div>
                                ))}
                              </div>
                ...
                <div className="flex w-full flex-col items-center gap-3">
                  ...
                  >
                    ...
                    <div className="text-left">
                      ...
                      <div className="text-xs text-slate-600">Reset and validate another batch</div>
                    </div>
                  </Button>
                </div>
