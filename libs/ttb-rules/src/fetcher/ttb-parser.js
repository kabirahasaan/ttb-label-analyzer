...
exports.TTBRulesParser = void 0;
/**
 * TTB Rules Parser
 * Extracts structured rules from TTB documents
 */
class TTBRulesParser {
    /**
     ...
     */
    parseBrandNameRules(doc) {
        return [
            {
                id: 'brand-name-required',
                name: 'Brand Name Required',
                category: 'required',
                description: 'All alcoholic beverage labels must display a brand name that is easily identifiable',
                requirements: [
            ...
            },
            {
                ...
                category: 'required',
                description: 'Brand names in foreign languages must be immediately followed by English translation',
                requirements: [
        ...
        return [
            {
                ...
                category: 'required',
                description: 'The percentage of alcohol by volume (ABV) must appear on all alcoholic beverage labels',
                requirements: [
        ...
        return [
            ...
            },
            {
                ...
                source: {
                    document: doc.title,
                    url: doc.url,
                    quotation: '"GOVERNMENT WARNING: (1) According to the Surgeon General, women should not drink alcoholic beverages during pregnancy because of the risk of birth defects. (2) Consumption of alcoholic beverages impairs your ability to drive a car or operate machinery, and may cause health problems."',
                },
                lastUpdated: doc.fetchedAt,
            },
            {
     ...
     */
    parseProhibitedStatementsRules(doc) {
        return [
            {
                id: 'no-health-claims',
...
exports.TTBRulesParser = TTBRulesParser;
//# sourceMappingURL=ttb-parser.js.map